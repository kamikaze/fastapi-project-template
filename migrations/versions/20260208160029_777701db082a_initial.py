...
def schema_upgrades() -> None:
    ...
    sa.ForeignKeyConstraint(['permission_uid'], ['rbac_permissions.uid'], name='fk_rbac_role_permissions_permission', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['role_uid'], ['rbac_roles.uid'], name='fk_rbac_role_permissions_role', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('role_uid', 'permission_uid', name='pk_rbac_role_permissions')
    )
    op.create_index(op.f('ix_rbac_role_permissions_permission_uid'), 'rbac_role_permissions', ['permission_uid'], unique=False)
    ...
    op.create_table('rbac_api_key_roles',
    sa.Column('api_key_uid', sa.UUID(), nullable=False),
    sa.Column('role_uid', sa.UUID(), nullable=False),
    sa.Column('starts_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['api_key_uid'], ['api_keys.uid'], name='fk_rbac_api_key_roles_user', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['role_uid'], ['rbac_roles.uid'], name='fk_rbac_api_key_roles_role', ondelete='CASCADE'),
